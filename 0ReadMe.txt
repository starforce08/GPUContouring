	...
	The contours in these two apps will adapt with the changes of the "而" value and the dem interpolation method in real time. Ofcourse it can adapt to dynamic grid DEM data too.
